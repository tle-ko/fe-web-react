  ...
  return (
    <div className="relative w-full h-9 justify-start items-center inline-flex">
      ...
      <div className="w-full">
        <div className="w-[27rem] h-0 ml-8 top-1/2 absolute border-2 border-color-blue-main"></div>
        <div className="absolute ml-8 top-0 justify-start items-center gap-16 inline-flex">
          {steps.map((step) => (
