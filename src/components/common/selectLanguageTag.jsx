...
const SelectLanguageTag = ({ language, onClick, selected }) => {
  ...
  return (
    <div
      className={`inline-flex items-center rounded-full px-3 py-2 font-pretendard text-sm font-semibold ${languageColor()} hidden-scrollbar cursor-pointer overflow-x-auto transition duration-300 ease-out`}
      onClick={onClick}
    >
